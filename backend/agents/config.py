...
# =============================================
from agents.spawner import SPAWNABLE_AGENTS, _HAIKU_MODEL, merge_ag013_subtasks, merge_ag007_sprints

# AG-005: LLM merger (necesita generar Acta+Alcance+meta_negocio coherente)
# Director+Merger en Sonnet (razonamiento complejo), Workers en Haiku
SPAWNABLE_AGENTS["AG-005"] = {
    ...
    "worker_model": _HAIKU_MODEL,
}

# AG-013: merger LLM (los workers mezclan texto narrativo con JSON)
# Director+Merger en Sonnet, Workers en Haiku
...
# Director en Sonnet, Workers en Haiku, merge sin LLM
