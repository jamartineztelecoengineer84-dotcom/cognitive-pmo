...
# F5 · alineado con authz.P96_ROLES + ROLE_LANDINGS del frontend (F4):
# - VP_OPERATIONS → /gov-run.html (no p96)
# - VP_ENGINEERING → /gov-build.html (no p96)
# - PMO_SENIOR / PMO_JUNIOR → /pm/ (no p96)
